...
arquivoPrincipal = os.path.basename(__file__)
arquivo = __file__.replace(arquivoPrincipal, "lista.txt")
...
print("programa finalizado. Obrigado por usar os produtas da plantsX LTDA")
