...
# PROGRAMA EXTREMAMENTE FALIDA NUNCA MAIS MEXO COM CORES
# SE VOCE ESTIVER NO FUTURO VENDO ISSO TENTE CONCERTAR PQ AGORA TA FODA
# ESSA PORRA DE FUNÇÃO NÃO QUER FUNCIONAR MESMO QUE EU TENHA ESCRITO TUDO CERTO
# JÁ CONFERI VARIAS VEZES
# REPITO NÃO MEXO MAIS COM CORES PRA EU PODER MIGRAR COMPLETAMENTE PRO VSCODE
# QUE SE FODA FICAR BONITO COM CORES QUANDO EU APRENDER A ABRRI JANELAS EU VEJO ESSA PORRA DE DEIXAR BONITO COM CORES
